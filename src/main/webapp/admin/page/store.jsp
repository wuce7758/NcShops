							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										...
										<th>
											<p class="text-center">
												<a class="blue buttongoods" href="javascript:void(0)" id="buttonadd" oper="add">
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="blue buttongoods" href="javascript:void(0)" name="${trl.sellerId}" oper="detaill">
														<i class="fa fa-search-plus bigger-130">
															<small></small>
														</i>
													</a>
													<a class="green buttongoods" href="javascript:void(0)"name="${trl.sellerId}" oper="modify">
														<i class="fa fa-pencil bigger-130">
															<small></small>
														</i>
													</a>
													<a class="red buttongoods" href="javascript:void(0)"name="${trl.sellerId}" oper="delete">
							...
							<form id="formgoodsinfo">
								...
								<div class="col-sm-12">
									...
									<div class="form-group col-sm-12">
										...
										<div class="col-sm-9">
											<textarea id="form-field-7" class="autosize-transition form-control" name="sellerMsg" placeholder="商家说明" maxlength="100"></textarea>
										</div>
									</div>
								</div>
								...
								<!-- 按钮操作 -->
								<div>
									<button id="sellerSave" style="margin-left:10px" class="btn btn-info col-sm-5" type="button">
